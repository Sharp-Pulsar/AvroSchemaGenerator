            ...
            else
            {
                if (IsUserDefined(p))
                {
                    ...
                    else
                    {
                        ...
                        {
                            existingTypes.Add(t);
                            return PropertyInfo(p, existingTypes);//throw new Exception($"The limit for user defined property type has been reached: [{dt}] public {p.PropertyType.Name} {p.Name} {{get; set;}}"); 
